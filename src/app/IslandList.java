...
public class IslandList {
	...
	public static List<Island> getIslands() {
		...
		islands.add(new Island("Old Faithful Isle", "Q4", "false", "false", "true", "true", "false"));
		...
		islands.add(new Island("Lone Cove", "J6", "false", "false", "true", "false", "false"));
		...
		islands.add(new Island("The Sunken Grove", "T8/U8", "false", "false", "true", "false", "false"));
		...
		islands.add(new Island("Crescent Isle", "B10/B11", "false", "false", "true", "false", "false"));
		...
		islands.add(new Island("Kraken's Fall", "X15", "false", "false", "true", "false", "false"));
		...
		islands.add(new Island("Devil's Ridge", "U24", "false", "false", "true", "false", "false"));
